...
public class Distance {
	 ...
	 * @return double[] _localDistanceGrid : Une nouvelle table construite avec les distances calculées pour toutes les valeurs
	 */
	...
	/**
	 * Accesseur permettant d'obtenir la valeur stockée dans une case spécifique de la table des distances _distanceGrid.
